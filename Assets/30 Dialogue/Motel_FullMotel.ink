...
Das ist, wenn man sich mal richtig was gönnen will.[nl] Dann bucht man sich halt nicht ein, sondern gleich drei Zimmer. #speaker:owner
...
Ich verbitte mir diesen Ton! Was ist das bitte hier für ein Motel??#speaker:marcus #emotion:ANGRY
...
Ja, der bin ich. #speaker:marcus #emotion:NORMAL
Du scheinst ja grade ein wenig in der Klemme zu stecken, so ganz ohne Unterkunft. #speaker:larry #emotion:NORMAL
Weißt du was? Ich will die Sache mit den Flecken wieder gut machen. Du kannst also bei mir zuhause übernachten! #speaker:larry #emotion:HAPPY
 * [Ja]   -> Ja
 * [Nein] -> Nein
