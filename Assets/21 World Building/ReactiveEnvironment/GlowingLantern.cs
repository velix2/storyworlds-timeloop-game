...
{
    // TODO: combine this together with GlowingWindow with inheritance
    public class GlowingLantern : MonoBehaviour
    {
        ...
        [SerializeField] private Renderer rendererTargetMaterial;
        ...
        private void Start()
        {
            ...
            for (var i = 0; i < rendererTargetMaterial.materials.Length; i++)
            {
                if (rendererTargetMaterial.materials[i].name != materialNameToReplace) continue;
            ...
            _initialMaterial =  rendererTargetMaterial.materials[_materialIndexToReplace];
        }
        ...
        private void OnTimePasssed(TimePassedEventPayload payload)
        {
            ...
            spotLight.SetActive(setLightIsOn);
        }

        private void OverrideMaterial(Material newMat)
        {
            // Get a copy of the current materials array
            Material[] tempMaterials = rendererTargetMaterial.materials;
            ...
            rendererTargetMaterial.materials = tempMaterials;
        }
