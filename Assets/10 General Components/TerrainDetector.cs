    ...
    public class TerrainTextureDetector : MonoBehaviour
    {
        ...
        public int GetDominantTextureIndexAt(Vector3 worldPosition)
        {
            ...
            for (int textureIndex = 0; textureIndex < textureCount; textureIndex++)
            {
                ...
                float textureWeight =
                    CachedTerrainAlphamapData[alphamapCoordinates.z, alphamapCoordinates.x, textureIndex];
        ...
        private static bool ContainsIndex(Array array, int index, int dimension)
        {
            if (index < 0)
                return false;
        ...
        private Vector3Int ConvertToAlphamapCoordinates(Vector3 _worldPosition)
            {
